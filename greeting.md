You can use this sidebar to filter and sort the data based on the columns available in the `IC50_expr_cnv.csv` table. Here are some examples of the kinds of questions you can ask me:
